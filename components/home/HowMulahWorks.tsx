...
const process = [
  {
    ...
    name: "Connect",
    icon: Layers,
    desc: "We securely sync your accounts via Plaid.",
  },
  {
    stepNumber: 2,
    name: "Track",
    icon: Activity,
    desc: "Automatically categorize your spending.",
  },
  {
    stepNumber: 3,
    name: "Reflect",
    icon: Sparkles,
    desc: "Add emotional context through journaling.",
  },
  {
    stepNumber: 4,
    name: "Visualize",
    icon: ChartColumnBig,
    desc: "Discover patterns in your emotions and finances.",
  },
  {
    stepNumber: 5,
    name: "Thrive",
    icon: TrendingUp,
    desc: "Make financial decisions that align with your priorities.",
  },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-16 mt-8 sm:mt-10 md:mt-12 lg:mt-14">
          {process.map((process, index) => (
            <div
              ...
              key={index}
            >
              <span className="text-white bg-linear-to-bl from-brandOrange to-brandBlue py-1.5 px-3 rounded-full absolute -top-5 left-2 text-xs md:text-sm">
                {" "}
                {process.stepNumber}{" "}
              </span>
              ...
              <h3 className="text-md md:text-lg lg:text-xl font-semibold text-[#2C2C2C]">
                {" "}
                {process.name}{" "}
              </h3>
              <p className="text-zinc-500 font-medium text-sm md:text-base leading-tight">
                {" "}
                {process.desc}{" "}
              </p>
            </div>
