...
const fullNameSchema = z.string().min(1, "Full name is required").max(20, "At max 20 characters are allowed")
...
const Waitlist: React.FC<WaitlistProps> = ({ onClose }) => {
    ...
    const handelFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!fullNameResult.success) {
            ...
            errors.push(fullNameResult.error.issues[0]?.message || "Invalid full name");
        }
        ...
        if (!occupationResult.success) {
            ...
            errors.push(occupationResult.error.issues[0]?.message || "Invalid occupation");
        }
            ...
            >
                ...
                <div className='w-full flex flex-col gap-1.5'>
                    ...
                    <Input
                        ...
                        className={`mt-4.5 text-neutral-300 px-6 text-sm md:text-base lg:text-lg bg-[#2c2c2c] outline-none border-none transition-colors ${isFullNameError ? 'ring-1 ring-red-500' : ''}`}
                    />
                    ...
                    <Input
                        ...
                        className={`mt-4.5 text-neutral-300 px-6 text-sm md:text-base lg:text-lg bg-[#2c2c2c] outline-none border-none transition-colors ${isEmailError ? 'ring-1 ring-red-500' : ''}`}
                    />
                    ...
                    <Input
                        ...
                        className={`mt-4.5 text-neutral-300 px-6 text-sm md:text-base lg:text-lg bg-[#2c2c2c] outline-none border-none transition-colors ${isOccupationError ? 'ring-1 ring-red-500' : ''}`}
                    />
                </div>
